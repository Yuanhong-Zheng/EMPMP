...
import json
from src.models.utils import visuaulize,seed_set,get_dct_matrix,gen_velocity,predict,update_metric,getRandomPermuteOrder,getRandomRotatePoseTransform
...
from src.baseline_3dpw.test import vim_test,random_pred
import shutil
...
parser.add_argument('--exp-name', type=str, default="3dpw数据集,baseline(预训练),no_norm", help='=exp name')
...
parser.add_argument('--model_path', type=str, default='预选连：baseline.pth')
