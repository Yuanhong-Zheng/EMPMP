...
def Get_RC_Data(motion_input,motion_target):#B,P,T,JK
    #加上速度维度
    ...
    k=3
    j=jk//k
    motion=torch.cat((motion_input,motion_target),dim=2)#B,P,T_in+T_out,JK
    
    vel_data = np.zeros((b, p, t, j,k))#b,p,T,J,3
