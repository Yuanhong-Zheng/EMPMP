...
from src.baseline_h36m_15to45.test import mpjpe_test_regress,regress_pred,mpjpe_vim_test
import shutil

parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument('--exp-name', type=str, default="+15->45", help='=exp name')
...
parser.add_argument('--scale', type=bool, default=False, help='Scale human data')
parser.add_argument('--num', type=int, default=64, help='=num of blocks')
parser.add_argument('--out_len', type=int, default=45, help='=num of blocks')
...
config.motion_mlp.out_len = args.out_len
