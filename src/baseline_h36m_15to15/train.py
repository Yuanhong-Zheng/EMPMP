...
from src.baseline_h36m_15to15.test import mpjpe_test_regress,regress_pred
import shutil
...
if config.dataset=="h36m":#没用，数据集不是h36m
    pass
else:
        ...
        if (nb_iter + 1) % config.save_every ==  0 or nb_iter==0: 
            with torch.no_grad():
                ...
                if config.dataset=="h36m":
                    ...
                    print(f"iter:{nb_iter},mpjpe_mupots:",mpjpe_res_mupots)#50->10:[0.09054746448865943];40->20:[0.15342454510210662];15->45:[0.123277035803999, 0.2059176816683756, 0.27401534203986566]
